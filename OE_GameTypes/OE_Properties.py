...
def convert_property_bin_to_beps(property_bin, game_oe, game_de, move_list, mep_folder, properties_oe, properties_de):
    '''
    :param property_bin: BinaryStream
    :param game_oe: String
    :param game_de: String
    :param move_list: Dictionary
    :param mep_folder: Path Object
    :param properties_oe: Dictionary
    :param properties_de: Dictionary
    '''
    writer = BinaryReader()
    bepfile.seek(0)
